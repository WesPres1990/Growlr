...
router.get("/person-input", function(req, res) {
  ...
  res.render("new_input_h", req.body);
...
router.get("/person-survey", function(req, res) {
    ...
    res.render("new_survey_h", req.body);
...
//home page
router.get("/", function(req, res) {
    Input_ds.findAll({}).then(function(result) {
        console.log(result);
...
//survey dog page
router.get("/new_survey_d", function(req, res) {
    res.render("new_survey_d");
});

//survey human page
router.get("/new_survey_h", function(req, res) {
    res.render("new");
});

//input dog page
router.get("/new_input_d", function(req, res) {
    res.render("new");
});

//input human page
router.get("/new_input_h", function(req, res) {
    res.render("new");
});
